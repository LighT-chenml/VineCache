...
def make_criteo_data_and_loaders(args, offset_to_length_converter=False):
    ...
    test_data = []
    percent_data_for_inference = args.percent_data_for_inference
    if args.cache_warmup == True:
        percent_data_for_inference = percent_data_for_inference * 2
    ...
    test_data = CriteoDataset(
        ...
        percent_data_for_inference, # 0.008 * 5mil = 40k
    )
