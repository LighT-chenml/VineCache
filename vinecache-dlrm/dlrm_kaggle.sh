...
$dlrm_pt_bin --arch-sparse-feature-size=36 --arch-mlp-bot="13-512-256-64-36" --arch-mlp-top="512-256-1" --data-generation=dataset --data-set=kaggle --mini-batch-size=128 --print-freq=1024 --print-time --test-mini-batch-size=1 --test-num-workers=0 $dlrm_extra_option 2>&1 
